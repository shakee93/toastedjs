<template>
    <div id="app">
        <div class="container t-wrapper">
            <header>
                <div class="row">
                    <div class="col-md-12 col-xs-12">
                        <h1 class="center">toasted<strong>js</strong></h1>
                    </div>
                </div>
            </header>
            <main class="row middle-xs">
                ...
                <div class="col-md-8 col-xs-10">
                    ...
                    <div class="t-container">
                        <div class="row t-inputs">
                            ...
                            <div class="col-md-6 col-xs-12">
                                ...
                                <div class="input">
                                    ...
                                    <select name="icon" id="icon" class="icon-select">
                                        <option v-for="icon in icons" :value="icon" :selected="icon == data.icon">
                                            <i class="material-icons">{{ icon }}</i></option>
                                    </select>
                                </div>
                        ...
                        <div class="row center-xs t-actions">
                            <div class="col-md-12">
                                <a href="#" @click.prevent="launch()" class="btn btn-launch">Launch</a>
                                <a href="#" @click.prevent="clear()" class="btn btn-launch">Clear</a>
                            </div>
                        </div>
                    </div>
